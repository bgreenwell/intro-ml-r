...
```{r data-sets-regression}
# See ?AmesHousing::make_ames for details
...
```{r data-sets-classification}
data(spam, package = "kernlab")
tibble::as_tibble(spam)  # see ?spam for details
```
...
```{r lets-go, echo=FALSE, out.width="100%"}
...
```{r black-box-nature, echo=FALSE, out.width="100%"}
...
```{r data-modeling-culture, echo=FALSE, out.width="100%"}
...
```{r algorithmic-modeling-culture, echo=FALSE, out.width="100%"}
...
class: clear, split-two white with-border

.column.bg-purple[.content[
...
Before introducing any algorithms, we'll briefly cover concepts that are useful for any type of machine learning model:
...
knitr::include_graphics("Figures/modeling_process2.png")
```
...
```{r xgboost-pdp-vi, echo=FALSE, fig.width=9, fig.height=6, out.width="80%"}
