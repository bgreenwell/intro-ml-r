...
* .purple[Data science]: applying mathematics, statistics, machine learning, engineering, etc. to extract knowledge form data
...
It is possible to "over tune" your models to maximize performance on the training data. Such models will not generalize well to new data. We call this process .red[*over fitting*]:
